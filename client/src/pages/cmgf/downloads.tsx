...
const documents = [
  ...
  {
    id: "presentation",
    title: "CMGF Conference Presentation",
    description: "Conference-grade slide deck explaining the Binder Layer concept. Covers research convergence, governance constraints, system architecture, and institutional positioning.",
    type: "Interactive",
    icon: Presentation,
    href: "/cmgf/presentation",
    version: "v1",
    date: "January 2026",
    isDownload: false
  }
