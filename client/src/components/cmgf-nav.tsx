...
import { Home, Download, Library, Search, Layers, ExternalLink, BarChart3, UserCircle, ClipboardList, Shield, Rocket, MonitorPlay, Compass, PlayCircle } from "lucide-react";
...
const navItems = [
  ...
  { href: "/research/signal-flow", label: "Signal Flow", icon: PlayCircle, external: false, group: "pipeline" },
