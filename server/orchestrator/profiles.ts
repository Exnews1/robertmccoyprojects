...
const PROFILE_TEMPLATES: Record<string, () => ProfileTemplate> = {
  ...
  medic_to_nursing: () => ({
    profileType: "medic_to_nursing",
    rank: pick(["E-5", "E-6"]),
    mos: "medical",
    mosLabel: "Medical (68W/68C)",
    yearsOfService: randomInt(5, 10),
    careerGoal: "nursing",
    goalLabel: "Nursing (RN/BSN)",
    constraints: [],
    credits: randomInt(15, 45),
    hasDegree: false,
    itExperience: false,
    clearanceLevel: "Secret",
    deploymentStatus: "garrison",
  ...
  medic_to_teaching: () => ({
    profileType: "medic_to_teaching",
    rank: pick(["E-6", "E-7"]),
    mos: "medical",
    mosLabel: "Medical (68W/68C)",
    yearsOfService: randomInt(8, 14),
    careerGoal: "teaching",
    goalLabel: "Teaching (Health Science/CTE)",
    constraints: [],
    credits: randomInt(30, 60),
    hasDegree: false,
    itExperience: false,
  ...
  combat_to_teaching: () => ({
    profileType: "combat_to_teaching",
    rank: pick(["E-6", "E-7"]),
    mos: "combat_arms",
    mosLabel: "Combat Arms (11B/19D)",
    yearsOfService: randomInt(8, 16),
    careerGoal: "teaching",
    goalLabel: "Teaching (JROTC/Secondary Education)",
    constraints: [],
    credits: randomInt(15, 45),
    hasDegree: false,
    itExperience: false,
  ...
  deployed_medic_nursing: () => ({
    profileType: "deployed_medic_nursing",
    rank: pick(["E-5", "E-6"]),
    mos: "medical",
    mosLabel: "Medical (68W/68C)",
    yearsOfService: randomInt(5, 8),
...
const PROFILE_TYPE_INFO: ProfileTypeInfo[] = [
  ...
  {
    type: "medic_to_nursing",
    label: "Medic → Nursing (RN/BSN)",
    group: "aligned",
    alignment: "88%",
    summary: "Combat medic skills translate directly to nursing clinical competencies. Strongest healthcare pipeline.",
  },
  {
    type: "medic_to_teaching",
    label: "Medic → Teaching (Health Science)",
    group: "aligned",
    alignment: "82%",
    summary: "Medical MOS provides CTE Health Occupations content expertise. Troops to Teachers eligible.",
  },
  {
    type: "combat_to_teaching",
    label: "Combat Arms → Teaching (JROTC)",
    group: "aligned",
    alignment: "72%",
    summary: "JROTC instructor path requires zero additional certification. Fastest teaching pipeline for NCOs.",
  },
  {
    type: "deployed_medic_nursing",
    label: "Deployed Medic → Nursing",
    group: "constrained",
    alignment: "88%",
    summary: "Strong clinical alignment but deployment + limited internet create access barriers for program enrollment.",
  },
];
